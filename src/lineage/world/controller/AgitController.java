...
public final class AgitController {
	 ...
	 * @param agit
	 */
	static private void update(Connection con, Agit agit){
		PreparedStatement st = null;
		try {
			...
			st.setString(2, agit.getChaName());
			st.setInt(3, agit.getClanId());
			st.setString(4, agit.getClanName());
			st.setString(5, agit.getAgitName());
