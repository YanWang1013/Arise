...
public final class QuestController {
	...
	static private List<Quest> pool;
	// 퀘스트 npc들..
	...
	static public void setPool(Quest q){
		q.close();
		pool.add(q);
	}
	...
	static public Quest newQuest(PcInstance pc, QuestInstance qi, String action){
		...
		q.setNpcName(qi.getNpc()==null ? qi.getName() : qi.getNpc().getName());
