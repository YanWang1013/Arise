...
public class CursePoison extends Magic {
	...
	static public BuffInterface clone(BuffInterface bi, Character cha, Skill skill, int time){
		if(bi == null)
	...
	public void toBuff(object o){
		...
		if(!o.isDead() && !o.isLockHigh())
			DamageController.toDamage(cha, o, Util.random(1, 3), Lineage.ATTACK_TYPE_MAGIC);
	}
