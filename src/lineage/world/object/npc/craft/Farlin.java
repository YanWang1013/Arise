...
public class Farlin extends CraftInstance {
	
	public Farlin(Npc npc){
		super(npc);
		...
		if(i != null){
			i.getListCraft().put("request lumps of metal sell", 5);
			craft_list.put("request lumps of metal sell", i);
