...
public class Serian extends FirstQuest {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp){
		...
		if(q.getQuestStep() == 0)
			...
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "orenb4"));
	}
		...
		if(action.equalsIgnoreCase("0")){
			...
			if(q!=null && q.getQuestStep()==0){
				...
				if(CraftController.isCraft(pc, l, true)){
					...
					q.setQuestStep( 1 );
					// 창 띄우기.
					pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "orenb3"));
				}
			}
		}
	}
