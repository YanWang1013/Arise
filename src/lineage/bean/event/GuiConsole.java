...
public class GuiConsole implements Event {
	...
	static public Event clone(Event e, MODE mode, String msg){
		if(e == null)
			e = new GuiConsole();
	...
	static public Event clone(Event e, MODE mode, Object o){
		if(e == null)
			e = new GuiConsole();
		((GuiConsole)e).setMode(mode);
	...
	static public Event clone(Event e, MODE mode, String format, Object ...args){
		if(e == null)
			e = new GuiConsole();
		((GuiConsole)e).setMode(mode);
