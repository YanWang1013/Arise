...
public class S_Html extends ServerBasePacket {
	...
	static public BasePacket clone(BasePacket bp, object o, String html){
		if(bp == null)
	...
	static public BasePacket clone(BasePacket bp, object o, String html, String request, List<?> list){
		if(bp == null)
